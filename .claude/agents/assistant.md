...
- **関連コンテキストが返った場合**: 回答に以下を必ず反映する: (1) 取得内容を回答に引用する際は出典をファイル名:行番号で明示する（例: `docs/overview/org-profile.md:42`） (2) 取得情報と既知情報が矛盾する場合は両方を提示してその旨を明示する (3) 推測で補わず、docs に記載がない事項は「資料に記載なし」と明示する
