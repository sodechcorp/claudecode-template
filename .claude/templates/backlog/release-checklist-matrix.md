...
### Apex トリガー
- **リリース前**: before/after 各経路・バルク 200 件・再帰防止の確認
...
### レコードタイプ
- **リリース前**: `recordTypeVisibilities`（プロファイル割当）・レイアウト割当・ピックリスト値制限の確認
